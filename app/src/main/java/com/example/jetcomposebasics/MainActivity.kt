...
import com.example.jetcomposebasics.scrollablelist.Affirmation
import com.example.jetcomposebasics.ui.theme.JetComposeBasicsTheme
import com.example.jetcomposebasics.scrollablelist.DataSource
...
fun AffirmationList(affirmationList: List<Affirmation>, modifier: Modifier = Modifier) {
    LazyColumn(modifier = modifier) {
        items(affirmationList.size) { index ->
            val affirmation = affirmationList[index]
            AffirmationCard(
